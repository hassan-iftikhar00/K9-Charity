...
export default function CTASection() {
  return (
    <section
      className="py-20 px-4 bg-secondary-500 text-white"
      style={{
        background:
    ...
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          <Gift size={64} className="mx-auto mb-6 text-white" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 text-black bg-white text-secondary-600 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors flex items-center justify-center gap-2"
            >
              Planned Giving
              <ArrowRight size={20} />
            </motion.button>
